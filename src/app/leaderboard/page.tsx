...
import { Github, LogOut, Swords } from "lucide-react";
...
export default async function LeaderboardPage({ searchParams }: PageProps) {
    ...
    if (user) {
        try {
            const githubUsername = user.user_metadata?.user_name as
                | string
                | undefined;
                ...
                <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <Link href="/battle">
                            <Button
                                size="sm"
                                className="cursor-pointer bg-zinc-900 text-[#EAB308] hover:bg-zinc-800 border border-zinc-700 font-semibold"
                            >
                ...
                <FadeIn>
                    <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Waterloo student GitHub rankings · scored by stars,
                            PRs, commits, endorsements &amp; ELO
                        </p>
                    </div>
                </FadeIn>
